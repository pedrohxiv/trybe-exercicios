...
describe('Testando a API Cacau Trybe', function () {
  ...
  describe('Usando o método GET em /chocolates/search', function () {
    it('Retorna os chocolates que contém "M" no nome', async function () {
      const response = await chai.request(app).get('/chocolates/search?name=M');
    ...
    it('Retorna um array vazio ao não encontrar nenhum chocolate', async function () {
      const response = await chai.request(app).get('/chocolates/search?name=Sonho');
  ...
  describe('Usando o método PUT em /chocolates/:id', function () {
    ...
    it('Se o chocolate não existe, gera um erro', async function () {
      const response = await chai.request(app).put('/chocolates/9999').send({
        name: 'Ferrero Rocher',
        brandId: 2,
      });
