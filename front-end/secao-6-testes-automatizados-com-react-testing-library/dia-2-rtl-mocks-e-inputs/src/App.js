...
class App extends React.Component {
  ...
  render() {
    const { diceQuantity, diceSize, selectedCharacterId, characters, attackResult } =
      this.state;

    const selectedCharacter = characters.length
      ? characters.find((character) => character.id === parseInt(selectedCharacterId, 10))
      : null;
      ...
      <main>
        ...
        {selectedCharacter && (
          <>
            ...
            <p>Origem: {selectedCharacter.source}</p>
            <p>Defesa: {selectedCharacter.defensePoints}</p>
          </>
        )}
        {attackResult && (
          <div className="battle">
            ...
            <h4>Resultado nos dados: {attackResult.attackPoints}</h4>
            <h4>
              Defesa de {selectedCharacter && selectedCharacter.name}:{' '}
