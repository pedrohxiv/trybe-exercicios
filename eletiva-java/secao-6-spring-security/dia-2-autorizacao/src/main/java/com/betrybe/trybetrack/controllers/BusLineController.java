...
public class BusLineController {
    ...
    public ResponseEntity<ResponseDTO<Schedule>> createSchedule(@PathVariable Long busLineId,
    ...
    public ResponseEntity<ResponseDTO<Schedule>> updateSchedule(@PathVariable Long scheduleId,
            @RequestBody ScheduleDTO scheduleDTO, @AuthenticationPrincipal Person person) {
