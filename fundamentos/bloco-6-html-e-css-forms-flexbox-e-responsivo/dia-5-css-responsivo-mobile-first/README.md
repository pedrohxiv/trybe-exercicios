...
**1 -** Utilizando a abordagem _mobile first_ e _media queries_, **crie três versões de layout diferentes para essa página**. Cada _layout_ deve corresponder a um tamanho diferente de página _(pequeno, médio e grande)_. Faça pelo menos um _commit_ para cada _layout_;
